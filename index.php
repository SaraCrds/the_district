...
<body class="body-bg bg-dark m-0 p-0">
<nav class="navbar navbar-expand-lg sticky-top navbar bg-black px-5" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Logo Entreprise</a>
          ...
          <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-caption d-flex flex-column justify-content-center h-100 p-0">
                  <h1>The District</h1>
                  <p class="slogan text-primary">Decouvrez de nouvelles saveurs!</p>
                </div>
            </div>
          </div>
            <div class="py-3">
            <h2 class="text-white text-center">Nos produits phares</h2>
                <h3 class="text-primary text-center">Essayez notre nouvelle selection</h3>
            </div>
        <div class="row justify-content-center w-100 m-0">
            <div class="bg-warning col-md-3">
            Nom produit 
            <br> Description<br> EN savoir plus
            </div>
